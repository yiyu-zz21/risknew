...
const formRules = reactive({
  ca19_9: [
    ...
    { pattern: /^[0-9]+(\.[0-9]+)?$/, message: t('common.pleaseEnter') + ' ' + t('dcc.form.ca19_9.label'), trigger: 'blur' }
  ],
  diameter: [
    { required: true, message: t('common.required'), trigger: 'blur' },
    { pattern: /^[0-9]+(\.[0-9]+)?$/, message: t('common.pleaseEnter') + ' ' + t('dcc.form.diameter.label'), trigger: 'blur' }
  ],
  differentiation: [
